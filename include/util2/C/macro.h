...
#   ifndef UTIL2_DO_PRAGMA
#      define UTIL2_DO_PRAGMA(X) _Pragma(#X)
#   endif /* !defined UTIL2_DO_PRAGMA */
#   ifndef DISABLE_WARNING_PUSH
#      define DISABLE_WARNING_PUSH           UTIL2_DO_PRAGMA(GCC diagnostic push)
#   endif /* !defined DISABLE_WARNING_PUSH */
#   ifndef DISABLE_WARNING_POP
#      define DISABLE_WARNING_POP            UTIL2_DO_PRAGMA(GCC diagnostic pop)
#   endif /* !defined DISABLE_WARNING_POP */
#   ifndef DISABLE_WARNING
#      define DISABLE_WARNING(warningName)   UTIL2_DO_PRAGMA(GCC diagnostic ignored #warningName)
